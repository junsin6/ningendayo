...
- **手段・原因の「によって」** A-3(通じて)にも A-8(行為者後置受動)にも当てはまらない「普及によって」「更新によって」「〜することによって」型。`hits: 2run`（06-12 は弱め、07-12 は 001・002 両方で明示）出所 detector-001, detector-002。→ 2026-07-12 taxonomist 審査へ回付。
